...
##(Upload Images)
        ...
        self.chatbot_img = self.chatbot_img.resize((80, 80), Image.LANCZOS)
        self.chatbot_img = ImageTk.PhotoImage(self.chatbot_img)
##TITLE
        title = Label(self.root, text = "CIA RESULT ", padx = 10, compound = LEFT,image = self.logo_img, font = ("courier new", 24, "bold","underline"), bg = "#652A0E", fg = "white").place(x = 0, y = 0, relwidth = 1, height = 50)
...
##Footer
        footer = Label(self.root, text = " CIA RESULT - Student Result Managemnet System - Oopsie Here :)\n ...", font = ("times new romen", 12,), bg = "#262626", fg = "white").pack(side = BOTTOM, fill = X)
