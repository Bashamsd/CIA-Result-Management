...
#column1
        ...
        self.txt_exam = ttk.Combobox(self.root, textvariable = self.var_exam, font = ("goudy old style", 15, "bold"),state='readonly',justify=CENTER,values=("CIA I","CIA II","Model Exam"))
